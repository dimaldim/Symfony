...
class __TwigTemplate_fff28dd08cd866de347767cf7e74c2065646f9e49f119e6531de295d277738c9 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "task/delete.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "task/delete.html.twig"));
    ...
    <form method=\"post\" action=\"";
        ...
        <div>
            <div>
                <input class=\"button deleteBtn\" type=\"submit\" value=\"Delete\">
...
{% block main %}
    ...
    <form method=\"post\" action=\"{{ path('delete', { id: task.id }) }}\">
        <div>
            <label class=\"desc\" for=\"title\">Title</label>
            <div>
                <input id=\"title\" name=\"task[title]\" type=\"text\" class=\"field text fn\" size=\"8\" tabindex=\"1\" value=\"{{ task.title }}\" autofocus disabled>
            </div>
        </div>
        ...
        <div>
            <fieldset>
                ...
                <div>
                    <div>
                        <input id=\"status1\" name=\"task[status]\" type=\"radio\" value=\"Open\" tabindex=\"2\" {{ task.status == 'Open' ? 'checked' : '' }} disabled>
                        <label class=\"choice\" for=\"status1\">Open</label>
                    </div>
                    <div>
                        <input id=\"status2\" name=\"task[status]\" type=\"radio\" value=\"In Progress\" tabindex=\"3\" {{ task.status == 'In Progress' ? 'checked' : '' }} disabled>
                        <label class=\"choice\" for=\"status2\">In Progress</label>
                    </div>
                    <div>
                        <input id=\"status3\" name=\"task[status]\" type=\"radio\" value=\"Finished\" tabindex=\"4\" {{ task.status == 'Finished' ? 'checked' : '' }} disabled>
                        <label class=\"choice\" for=\"status3\">Finished</label>
                    </div>
                </div>
            </fieldset>
...
{% endblock %}", "task/delete.html.twig", "C:\\Users\\Mitko\\Desktop\\CRUD\\TeisterMask\\app\\Resources\\views\\task\\delete.html.twig");
    }
}
