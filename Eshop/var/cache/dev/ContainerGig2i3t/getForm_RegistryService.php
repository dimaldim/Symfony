...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('EShopBundle\\Form\\ProductType' => function () {
    return ${($_ = isset($this->services['EShopBundle\Form\ProductType']) ? $this->services['EShopBundle\Form\ProductType'] : $this->services['EShopBundle\Form\ProductType'] = new \EShopBundle\Form\ProductType()) && false ?: '_'};
}, 'EShopBundle\\Form\\UserType' => function () {
    return ${($_ = isset($this->services['EShopBundle\Form\UserType']) ? $this->services['EShopBundle\Form\UserType'] : $this->services['EShopBundle\Form\UserType'] = new \EShopBundle\Form\UserType()) && false ?: '_'};
